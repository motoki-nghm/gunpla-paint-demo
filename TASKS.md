...
| ---- | ------------ | --------------------------------------------------- | ---------- | ---------------- |
| T011 | GON          | App.tsx 統合・画面フロー接続                        | ⬜ pending | T004〜T010       |
| T012 | FEITAN       | セキュリティ監査 (APIキー露出・画像バリデーション)  | ⬜ pending | T004, T008       |
| T013 | KNUCKLE      | コードレビュー (全コンポーネント)                   | ⬜ pending | T011             |

### Phase 4 — ドキュメント & 仕上げ

| ID   | エージェント | タスク                                              | ステータス | 依存       |
| ---- | ------------ | --------------------------------------------------- | ---------- | ---------- |
| T014 | BISCUIT      | README.md 作成 (セットアップ手順・使い方)           | ⬜ pending | T013       |
| T015 | BISCUIT      | .env.example 作成・DECISIONS.md 更新                | ⬜ pending | T012       |
| T016 | GON          | 最終確認・Vercel デプロイ設定                       | ⬜ pending | T014, T015 |
